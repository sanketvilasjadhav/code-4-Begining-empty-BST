...
i. Insert new node
ii.  ii. Find number of nodes in longest path
iii.  iii. Minimum data value found in the tree 
iv. iv. Change a tree so that the roles of the left and right pointers are swapped at every node
v.  v. Search a value */
